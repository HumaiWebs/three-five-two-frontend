...
export default function Header() {
  ...
  // Temporary cart state for demonstration; replace with your actual cart logic
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-10 absolute left-1/2 transform -translate-x-1/2">
            <Link
              href="/"
              className="text-xs font-normal uppercase tracking-widest text-white hover:text-gold transition-colors"
            >
              HOME
            </Link>
            <Link
